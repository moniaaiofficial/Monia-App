  ...
  return (
    <main className="min-h-screen bg-[#0f0102] text-white">
      ...
      <div className="px-6 py-8 max-w-3xl mx-auto space-y-6 text-[#e0e0e0]">
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">2. Age Requirement</h3>
          <p className="font-semibold text-white">
            Users must be 13 years or older to use MONiA.
          </p>
          <p>
            If you are under 13 years of age, you are not permitted to use this platform.
          </p>
        </section>

        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">3. Prohibited Activities</h3>
          <p>
            Users must NOT use MONiA for:
          </p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">4. Account Suspension</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">5. Media Auto-Deletion Policy</h3>
          <p className="font-semibold text-white">
            All media files automatically expire and are deleted after 48 hours.
          </p>
          <p>
            This includes:
          </p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">6. User-Generated Content</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">7. Payments and Transactions</h3>
          <p>
        ...
        <section className="space-y-3">
          ...
          <p>
            MONiA is provided &quot;as is&quot; without warranties of any kind. We are not liable for:
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">9. Privacy and Data Security</h3>
          <p>
            Your privacy is important to us. Please review our Privacy Policy to understand how we collect, use, and protect your information.
          </p>
          <p className="font-semibold text-white">
            Note: MONiA does NOT use end-to-end encryption.
          </p>
        </section>

        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">10. Modifications to Terms</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">11. Intellectual Property</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold text-white">13. Contact Information</h3>
          <p>
        ...
        <section className="space-y-3 mt-8 p-4 border border-[#fc2857] rounded-lg">
          <p className="text-sm">
