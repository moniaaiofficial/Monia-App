  ...
  return (
    <main className="min-h-screen text-white" style={{ background: '#14141f' }}>
      ...
      <div className="px-6 py-8 max-w-3xl mx-auto space-y-6" style={{ color: 'rgba(255,255,255,0.70)' }}>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>1. Information We Collect</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>2. How We Use Your Information</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>3. Data Storage and Security</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>4. Media Files Auto-Deletion</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>5. Data Sharing</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>6. Your Rights</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>7. Account Deletion</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>8. Changes to Privacy Policy</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>9. Contact Us</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>10. Messaging &amp; Data Transmission</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>11. Message Retention &amp; Deletion</h3>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>12. Realtime Data</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>13. Device Permissions</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold" style={{ color: '#ff0066' }}>14. Progressive Web App (PWA)</h3>
          <p>
